...
$sql = $conexion->prepare("SELECT MAX(Id_Oferta) AS UltimoId FROM Oferta WHERE DNI_CIF = ? AND Id_Oferta= ?");
$sql->bindParam(1, $dni);
    ...
    <div class="main-content">
        ...
        <section class="main-info">
            <div class="breadcrumbs">
                <h1 id="breadcrumbs-title">Empresa / <span>Editar oferta</span></h1>
...
if ($resultado = $conexion->query($query)) {
    while ($rowResultado = $resultado->fetch(PDO::FETCH_OBJ)) {
        ...
        echo '<input type="submit" name="borrarHardSkill" value="Borrar"><br>';
        echo '</form>';
        echo "</div>";
    }
...
?>
            ...
            <a href="ofertas"><button>Mis ofertas</button></a>
