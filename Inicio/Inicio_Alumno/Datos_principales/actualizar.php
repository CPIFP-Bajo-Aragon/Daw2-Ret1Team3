...
try {
    ...
    $query = "UPDATE Alumno SET Apellido = :apellido, Fecha_Nacimiento = :fechaNacimiento, Telefono_Alumno = :telefonoAlumno, Movilidad = :movilidad, Direccion = :direccion, Perfil_Publico = :perfilPublico, Id_Municipio = :idMunicipio, Coche = :Coche WHERE DNI_CIF = :dni";
    $stmt = $conexion->prepare($query);
