...
<form method="POST" onsubmit="return validarFechas()" action=" ./Titulaciones/actualizar.php">
        ...
        <?php
                ...
                if ($result = $conexion->query($query)) {
                    while ($row = $result->fetch(PDO::FETCH_OBJ)) {
                        ...
                        $Id_Municipio = $row->Id_Municipio; ?> <option value="<?php echo $Id_Centro?>">
            <?php echo $Nombre_Centro?></option> <?php
                    }
                }
                ?>
        ...
        <?php
                ...
                if ($result = $conexion->query($query)) {
                    while ($row = $result->fetch(PDO::FETCH_OBJ)) {
                        ...
                        $Tipo = $row->Tipo;
                        $Horas = $row->Horas;
                        ?> <option value="<?php echo $Id_Tipo_Titulacion?>"><?php echo $Tipo." - ".$Nombre_Titulacion?>
        </option> <?php
                    }
                }
                ?>
