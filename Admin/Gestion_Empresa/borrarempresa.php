...
try {
    ...
    $nuevaAlerta = "Empresa borrada por un Administrador  (Si esto es un error <a target='_blank' href='../../Reportes/index.php'>contacta con un Administrador</a> para que lo reactive)";
    $vista = 1;
